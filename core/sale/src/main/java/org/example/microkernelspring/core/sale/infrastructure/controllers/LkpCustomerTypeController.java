...
import org.example.microkernelspring.core.sale.application.services.LkpCustomerTypeQueryService;
...
public class LkpCustomerTypeController {

    private final LkpCustomerTypeQueryService queryService;

    /** GET /api/customer-types — lista completa (catálogo pequeño, sin paginación) */
    @GetMapping
